...
- seekTo (number; optional): Seek to the given number of seconds, or fraction if amount is between 0 and 1"""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, url=Component.UNDEFINED, playing=Component.UNDEFINED,
                 loop=Component.UNDEFINED, controls=Component.UNDEFINED, volume=Component.UNDEFINED,
                 muted=Component.UNDEFINED, playbackRate=Component.UNDEFINED, width=Component.UNDEFINED,
                 height=Component.UNDEFINED, style=Component.UNDEFINED, playsinline=Component.UNDEFINED,
                 currentTime=Component.UNDEFINED, secondsLoaded=Component.UNDEFINED, duration=Component.UNDEFINED,
                 intervalCurrentTime=Component.UNDEFINED, intervalSecondsLoaded=Component.UNDEFINED,
                 intervalDuration=Component.UNDEFINED, seekTo=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'url', 'playing', 'loop', 'controls', 'volume', 'muted', 'playbackRate', 'width',
                            'height', 'style', 'playsinline', 'currentTime', 'secondsLoaded', 'duration',
                            'intervalCurrentTime', 'intervalSecondsLoaded', 'intervalDuration', 'seekTo']
        self._type = 'DashPlayer'
        self._namespace = 'dash_player'
        self._valid_wildcard_attributes = []
        self.available_properties = ['id', 'url', 'playing', 'loop', 'controls', 'volume', 'muted', 'playbackRate',
                                     'width', 'height', 'style', 'playsinline', 'currentTime', 'secondsLoaded',
                                     'duration', 'intervalCurrentTime', 'intervalSecondsLoaded', 'intervalDuration',
                                     'seekTo']
        ...
        if (any(getattr(self, c, None) is not None
            ...
            wilds_string = ', '.join([c + '=' + repr(getattr(self, c, None))
                                      ...
                                      if any([c.startswith(wc_attr)
                                              for wc_attr in
                                              self._valid_wildcard_attributes])])
            return ('DashPlayer(' + props_string +
